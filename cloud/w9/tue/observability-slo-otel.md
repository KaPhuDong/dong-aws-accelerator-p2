# W9 Day B - Observability: SLO/SLI, OpenTelemetry, Prometheus, Grafana, Loki

Ngày học: T3 09/06/2026  
Chủ đề: Deliver Smartly phần 2 - Observability, SLO/SLI, OpenTelemetry và burn rate alert
...
| 60 phút | Học SLI, SLO, error budget và burn rate | Tính được error budget đơn giản |
...
### 2. SLI, SLO và error budget

SLI là chỉ số đo chất lượng dịch vụ. SLO là mục tiêu chất lượng dịch vụ. Error budget là phần lỗi được phép xảy ra mà vẫn nằm trong SLO.
...
| SLI latency | Tỷ lệ request dưới 300ms |
...
- [ ] Giải thích được SLI, SLO, error budget và burn rate.
...
- Tóm tắt SLI/SLO đã chọn cho app.
